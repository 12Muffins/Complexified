package net.muffin.complexified.foundation.lang;
...
public class ComplexifiedLang extends Lang {
    public static MutableComponent translateDirect(String key, Object... args) {
        Object[] args1 = LangBuilder.resolveBuilders(args);
        return Component.translatable(Complexified.MOD_ID + "." + key, args1);
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(Complexified.MOD_ID);
    }
